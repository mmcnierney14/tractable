...
import edu.dartmouth.cs.tractable.gae.ServerUtilities;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onMessage(Context arg0, Intent arg1) {
		...
		if (extras != null) {
            ...
            if (changeType.equals(Globals.DELETE)) {
            	BathroomSessionHelper.deleteEntryInDB(context, id);
            	Log.i(Globals.TAG, "Should delete");
            }
		}
	}
